...
class GRU4Rec(nn.Module):
    def __init__(self, user_num, item_num, args):
        ...
        self.gru = nn.GRU(args.hidden_units, args.hidden_units, args.num_layers, batch_first=True)
        self.fc = nn.Linear(args.hidden_units, self.item_num)
